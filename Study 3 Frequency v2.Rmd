...
for (wd in wd_add) {
  ...
  if (wd == "2018-2019") {
    facial_frequency <- empty_dataframe
  } else {
    facial_frequency <- rbind(facial_frequency, empty_dataframe)
  }
}
setwd(paste0(root_wd, "Ratings"))
save(facial_frequency, file = "facial_frequency.Rda")
write.csv(facial_frequency, "facial_frequency.csv")
